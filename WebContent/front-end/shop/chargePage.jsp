...
<head>
  ...
  <title>儲值頁面</title>
	...
	<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/front-end/shop/css/numpad.css">
	
	<link rel="stylesheet" href="<%=request.getContextPath()%>/front-end/shop/css/creditcardReset.min.css">
	<link rel="stylesheet" href="<%=request.getContextPath()%>/front-end/shop/css/creditcardStyle.css">
...
<div class="wrapper" id="app">
    <div class="card-form">
      ...
      <div class="card-form__inner">
        ...
        <form  name="chargeForm" action="<%=request.getContextPath()%>/wallet/wallet.do?action=chargewallet" method="POST">
        <div class="card-input">
          <label for="cardNumber" class="card-input__label">金額輸入</label>
          <input type="text" class="card-input__input" id="demo-numpad-1" name="w_amount">
        </div>
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/front-end/shop/js/numpad.js"></script>
	<!-- partial -->
	<script src='<%=request.getContextPath()%>/front-end/shop/js/creditcardVue.min.js'></script>
	<script src='<%=request.getContextPath()%>/front-end/shop/js/creditcardVue-the-mask.js'></script>
	<script  src="<%=request.getContextPath()%>/front-end/shop/js/creditcardScript.js"></script>
