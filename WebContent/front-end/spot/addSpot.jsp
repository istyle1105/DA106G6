...
<table id="table-1">
	<tr><td>
		 <h3>景點資料新增 - addSpot.jsp</h3></td><td>
		 <h4><a href="<%=request.getContextPath()%>/front-end/spot/select_page.jsp"><img src="images/tomcat.png" width="100" height="100" border="0">回首頁</a></h4>
	</td></tr>
</table>
