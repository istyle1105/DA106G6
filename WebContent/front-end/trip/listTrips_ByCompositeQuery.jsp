...
<%-- 			<td>${tripVO.last_mod_time}</td> --%>
			...
			<td>
				<input type="button"  class="btn btn-success"  ${(tripVO.mem_no==mem_no)?"disabled value='團主'":"value='參加'" }  onclick="location.href='<%=request.getContextPath()%>/front-end/trip_list/addTrip_list.jsp?trip_id=${tripVO.trip_id}'">
