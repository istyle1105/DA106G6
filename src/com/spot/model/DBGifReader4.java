...
//�ĥ|��:�N�S���ѼƤ��ɮצW�٥�����,��ܫ��w���Ϥ��N���쥻�ťխ�����404����
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			...
			String empno = req.getParameter("spot_id").trim();
			ResultSet rs = stmt.executeQuery(
				"SELECT spot_pic FROM Spot WHERE Spot_id ='"+empno+"'");

			if (rs.next()) {
				BufferedInputStream in = new BufferedInputStream(rs.getBinaryStream("spot_pic"));
