...
//�ĥ|��:�N�S���ѼƤ��ɮצW�٥�����,��ܫ��w���Ϥ��N���쥻�ťխ�����404����
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			...
			String empno = req.getParameter("tour_id").trim();
			ResultSet rs = stmt.executeQuery(
				"SELECT tour_pic FROM tour WHERE tour_id ='"+empno+"'");

			if (rs.next()) {
				BufferedInputStream in = new BufferedInputStream(rs.getBinaryStream("tour_pic"));
