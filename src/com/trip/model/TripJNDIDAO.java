...
public class TripJNDIDAO implements TripDAO_interface {
	...
	private static final String INSERT_STMT = 
		...
		private static final String GET_ALL_MY_TRIP_STMT = 
				"SELECT TRIP_ID,MEM_NO,TOUR_ID,MEM_AMOUNT,DAYS,to_char(FIRST_DATE,'yyyy-mm-dd')FIRST_DATE,to_char(LAST_DATE,'yyyy-mm-dd')LAST_DATE,TRIP_PRICE,to_char(REG_START,'yyyy-mm-dd')REG_START,to_char(REG_DEADLINE,'yyyy-mm-dd')REG_DEADLINE,MEM_LIMITED,CURRENT_MEM,TRIP_STATUS,TOUR_STATUS,LAST_MOD_TIME FROM trip where MEM_NO=?  ORDER BY FIRST_DATE";
...
//			System.out.println("●●finalSQL(by DAO) = "+finalSQL);
	...
	public static void main(String[] args) {
		...
		TripJNDIDAO dao = new TripJNDIDAO();
