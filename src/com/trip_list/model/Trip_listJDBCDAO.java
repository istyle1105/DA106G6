...
public class Trip_listJDBCDAO implements Trip_listDAO_interface{
	...
	public static void main(String[] args) {
		...
		Trip_listJDBCDAO dao = new Trip_listJDBCDAO();
...
//		List<Trip_listVO> list = dao.getAllByMem_no("M0003");
//		for (Trip_listVO trip_list : list) {
//			System.out.print(trip_list.getTrip_id() + ",");
//			System.out.print(trip_list.getMem_no() + ",");
//			System.out.print(trip_list.getComment_content()+ ",");
//			System.out.print(trip_list.getCheck_status()+ ",");
//			System.out.print(trip_list.getRate()+ ",");
...
//		}
		...
		List<Trip_listVO> list = dao.getAllByTrip_id("T0004");
		for (Trip_listVO trip_list : list) {
			System.out.print(trip_list.getTrip_id() + ",");
			System.out.print(trip_list.getMem_no() + ",");
			System.out.print(trip_list.getComment_content()+ ",");
